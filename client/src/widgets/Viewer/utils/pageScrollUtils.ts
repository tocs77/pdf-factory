  ...
  if (pageDifference > 50) {
    ...
    if (pageDifference > 200 && containerRef.current) {
      ...
      setTimeout(() => {
        ...
        const targetElement = document.getElementById(`page-${newPage}`);
        if (targetElement) {
          ...
          const closestElement = document.getElementById(`page-${closestPage}`);
          if (closestElement) {
      ...
      const midPointElement = document.getElementById(`page-${midPoint}`);
      ...
      if (midPointElement) {
        ...
        setTimeout(() => {
          ...
          if (targetElement) {
            ...
            setTimeout(() => {
              const finalCheck = document.getElementById(`page-${newPage}`);
              if (finalCheck) {
