...
const PdfViewerInternal = ({ url }: PdfViewerProps) => {
  ...
  const adjustScrollPositionAfterZoomOnPage = useCallback(
    (container: HTMLDivElement, zoomData: {
      oldScale: number;
      newScale: number;
      mouseXDoc: number;
      mouseYDoc: number;
  ...
  }, [scale, dispatch, adjustScrollPositionAfterZoomOnPage]);
  ...
  }, [scale, dispatch, findVisiblePageElement, adjustScrollPositionAfterZoomOnPage]);
